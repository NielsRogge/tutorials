# Claude Agents SDK with MongoDB MCP

This repository showcases how to combine the [Claude Agents SDK](https://platform.claude.com/docs/en/agent-sdk/overview) (formerly called Claude Code SDK) with the official [MongoDB MCP server](https://github.com/mongodb-js/mongodb-mcp-server).

## Overview

The MongoDB MCP server allows Claude or any other LLM to interact with your MongoDB databases directly - querying data, listing collections, analyzing schemas, and more. This integration enables powerful database operations through natural language, having agents automatically writing to a database, and more.
